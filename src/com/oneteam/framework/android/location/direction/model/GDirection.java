 ...
 * *****************************************************************************************************************</br>
 */
package com.oneteam.framework.android.location.direction.model;
 ...
 * @goals This class aims to define a GoogleDirection which is bound to the JSon
 *        structure returned by the webService :
...
public class GDirection {
	...
	/**
	 * @param mNorthEastBound
	 *            the mNorthEastBound to set
	 */
	...
	/**
	 * @param mSouthWestBound
	 *            the mSouthWestBound to set
	 */
