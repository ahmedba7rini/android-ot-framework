...
package com.oneteam.framework.android.location;

import android.content.Context;
import android.location.Location;

import com.oneteam.framework.android.R;
import com.oneteam.framework.android.app.AbstractApplication;
...
public final class LocationUtils {
	...
	public static final String SHARED_PREFERENCES = AbstractApplication
			.getApplication().getPackageName() + "_preferences";

	// Key for storing the "updates requested" flag in shared preferences
	public static final String KEY_UPDATES_REQUESTED = "KEY_UPDATES_REQUESTED";
