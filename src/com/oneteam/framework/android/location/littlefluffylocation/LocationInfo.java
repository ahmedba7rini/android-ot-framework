...
public class LocationInfo implements Serializable {
    ...
    public void refresh(final Context context) {
        ...
        lastSpeed = prefs.getFloat(LocationLibraryConstants.SP_KEY_LAST_LOCATION_UPDATE_SPEED, 0.0F);
    ...
    public String toString() {
        return (String.format("lastLocationUpdateTimestamp=%1$s lastLocationBroadcastTimestamp=%2$s lastLat=%3$.6f lastLong=%4$.6f lastSpeed=%5$.2f lastAccuracy=%6$d",
                ...
                lastLat, lastLong, lastSpeed, lastAccuracy));
    }
}
